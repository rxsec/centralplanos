...
const defaultSteps: FlowStep[] = [
  ...
  { id: "name", state: "ASK_NAME", title: "Nome completo", message: "Boa notícia 🎉! Temos viabilidade no CEP {{cep}}, localizado {{endereco}}. Consigo te atender com a Claro 🚀. Para seguir com a contratação, preciso coletar alguns dados seus.\n\n*QUAL SEU NOME COMPLETO?*" },
  ...
  { id: "confirm", state: "CONFIRM_DATA", title: "Confirmação dos dados", message: "🎉 Informações registradas com sucesso!\n\nConfirmar CEP, nome, documento, data de nascimento, endereço, e-mail, data de vencimento e plano. Se a cliente responder não, permitir correção. Se responder sim, criar lead na aba Leads." },
