        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Distribuição de leads por funcionária, planos vendidos, status, conversas finalizadas pela Marcia, assumidas, tarefas e despesas em um único lugar.
            </p>
          </div>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <Card className="rounded-[24px] border-slate-200 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Fluxo da Marcia, operação humana e custos em um resumo visual.</CardDescription>
          </CardHeader>
